...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate('/'); // Redirects to role-based dashboard via MainLayout or logic
        } catch {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100">
            <div className="bg-white p-8 rounded shadow-md w-96">
                <h2 className="text-2xl font-bold mb-6 text-center text-primary">University Timetable</h2>
