...
# Monkey Patch PyMySQL version to fool Django
# Django 6.0 requires mysqlclient 2.2.1+
# PyMySQL reports 1.4.6, so we fake it.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'university_timetable'),
...
# JWT Configuration
# SECURITY: Token expiration and rotation
SIMPLE_JWT = {
